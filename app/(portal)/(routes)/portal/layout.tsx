  ...
  return (
    <PortalProgressProvider>
      <div className="min-h-screen lg:pb-0 w-screen h-screen max-h-screen overflow-hidden flex flex-col">
        <header className="flex justify-center items-center h-[20px] min-h-[20px] flex-[0.05] z-10 relative w-[160px] mx-auto">
          <h1 className="uppercase tracking-wider font-[300] heading-font">
            Four of Foes
          </h1>
        </header>

...
const PortalNavbar = ({ unreadMessages:messages } : { unreadMessages: Message[] }) => {
  ...
  return (
    <div className="grid grid-cols-3 gap-8 w-full h-[100px] pb-12 relative justify-center lg:pb-0" ref={containerRef}>
      {LINKS.map((link, i) => (
        <div
        ...
        >
          ...
          <motion.div
            className="h-2 w-2 bg-[grey] rounded-full absolute lg:bottom-[20px] bottom-[40px] mr-[1px]"
